...
# Dataset Path
# =============================================================================
prefixPathCOCO = './data/coco/'
prefixPathVG = './data/vg/'
prefixPathVOC2007 = './data/voc_devkit/VOC2007/'
# =============================================================================
...
def arg_parse(mode):
    ...
    parser.add_argument('--mode', type=str, default='SARB', choices=['SARB'],
                        help='mode of experiment (default: SARB)')
    ...
    if mode == 'SARB':
        ...
        parser.add_argument('--contrastiveLossWeight', type=float, default=1.0,
                            help='weight of contrastiveloss (default: 1.0)')

        # 添加 SupCon 的温度系数参数
        parser.add_argument('--supConTemp', type=float, default=0.1, help='temperature for SupCon Loss (default: 0.1)')

        parser.add_argument('--prototypeNum', type=int, default=10, help='number of the prototype (default: 10)')
        parser.add_argument('--recomputePrototypeInterval', type=int, default=5,
                            help='interval of recomputing prototypes whose value greater than zero means recomputing prototypes (default: 5)')

        parser.add_argument('--isAlphaLearnable', type=str2bool, default='True',
                            help='whether to set alpha be learnable  (default: True)')
        parser.add_argument('--isBetaLearnable', type=str2bool, default='True',
                            help='whether to beta be learnable (default: True)')

    # Only SARB is supported in this simplified project version.
